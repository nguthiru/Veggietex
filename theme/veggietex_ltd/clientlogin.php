...
<head>
    <title>Veggietex Client Login</title>
    <meta charset="utf-8" />
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <h1 class="mb-0 bread">Login To Veggietex Today</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    ...
                    <form action="clientlogin.php" class="bg-white p-5 contact-form" method="POST" autocomplete="">
                        ...
                        <div class="link forget-pass text-center">Did you forget password<a href="clientforgotpassword.php"> Click here?</a></div>

                        <div class="link login-link text-center">Not yet registered? <a href="clientsignup.php">Sign Up now</a></div>
                    </form>
                </div>
