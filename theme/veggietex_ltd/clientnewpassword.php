...
<head>
    <title>Veggietex Client New Password</title>
    <meta charset="utf-8" />
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <h1 class="mb-0 bread">Create New Password</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    ...
                    <form action="clientnewpassword.php" class="bg-white p-5 contact-form" method="POST" autocomplete="">
                        ...
                        <div class="form-group">
                            <input type="submit" name="change-password" value="Change" class="btn btn-primary py-3 px-5" />
                        </div>
