...
<head>
    <title>Veggietex Client Forgot Password</title>
    <meta charset="utf-8" />
        ...
        <div class="container">
            ...
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    ...
                    <form action="clientforgotpassword.php" class="bg-white p-5 contact-form" method="POST" autocomplete="">
                        ...
                        <div class="form-group">
                            <input type="submit" name="check-email" value="Continue" class="btn btn-primary py-3 px-5" />
                        </div>
