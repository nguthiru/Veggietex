...
<head>
    <title>Veggietex Client Register</title>
    <meta charset="utf-8" />
        ...
        <div class="container">
            <div class="row no-gutters slider-text align-items-center justify-content-center">
                <div class="col-md-9 ftco-animate text-center">
                    ...
                    <h1 class="mb-0 bread">Create An Account Today</h1>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row block-9">
                <div class="col-md-6 order-md-last d-flex">
                    ...
                    <form action="clientsignup.php" class="bg-white p-5 contact-form" method="POST" autocomplete="">
                        <?php
                        if (count($errors) == 1) {
                        ?>
                        ...
                        <div class="link login-link text-center">Already a registered? <a href="clientlogin.php">Login here</a></div>
